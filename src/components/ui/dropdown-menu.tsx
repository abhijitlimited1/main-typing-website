  ...
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        ...
        "bg-white text-gray-900 dark:bg-gray-800 dark:text-white", // Explicit colors for better visibility
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "text-gray-900 dark:text-white", // Explicit colors for better visibility
